        ...
        <div className="p-4">
          ...
          <div className="mt-5 flex items-end justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="mt-4 text-sm text-white/70">Saldo punktów</p>
              <p className="mt-1 text-4xl font-bold tabular-nums leading-none">
                {formatPoints(points)}
              </p>
              <p className="mt-2.5 font-mono text-sm tracking-[0.14em] text-white/80">
                {grouped}
              </p>
              <AppButton
                size="sm"
                className="mt-4 border-0 bg-white text-primary shadow-none hover:bg-accent-light"
